...
- **Name:** Banner
- **Role:** Data Engineer
- **Expertise:** Drift, migrations, schemas
...
**I handle:** Drift, migrations, schemas
...
- **Rationale:** Schema/migration/data work — Opus for correctness on SQL + Drift migrations
