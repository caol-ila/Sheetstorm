...
> **Status:** Entschieden durch Thomas  
> **Thomas-Entscheidung:** 18 Features übernommen, restliche Features im Backlog.  
...
|---|---------|:---------:|:--------:|:-----------:|:-------:|
| 0 | **GEMA-/Verwertungsgesellschaft-Meldung** | 🔴 Hoch | ✅ Übernommen | MS2 | Mittel |
...
| 4 | 1-Klick-Stimmenneuverteilung | 🔴 Hoch | 🔜 Backlog | MS1 | Klein |
| 5 | Musikalische Stempel-Bibliothek | 🔴 Hoch | 🔜 Backlog | MS1 | Mittel |
| 6 | Kalender-Sync (Google/Apple/Outlook) | 🔴 Hoch | ✅ Übernommen | MS2 | Mittel |
| 7 | Chat / Gruppen-Messaging | 🔴 Hoch | 🔜 Backlog | MS2 | Groß |
| 8 | Zweiseitenansicht (Two-Up-Modus) | 🔴 Hoch | ✅ Übernommen | MS1 | Klein |
| 9 | Link Points für Wiederholungen | 🟡 Mittel | ✅ Übernommen | MS1 | Mittel |
| 10 | Dirigenten-Mastersteuerung (Song-Broadcast) | 🟡 Mittel | ✅ Übernommen | MS2 | Groß |
| 11 | Dark Mode / Nachtmodus / Sepia | 🟡 Mittel | ✅ Übernommen | MS1 | Klein |
| 12 | Anwesenheitsstatistiken | 🟡 Mittel | ✅ Übernommen | MS2 | Mittel |
| 13 | Register-basierte Benachrichtigungen | 🟡 Mittel | ✅ Übernommen | MS2 | Klein |
| 14 | Nachrichten-Board / Pinnwand | 🟡 Mittel | ✅ Übernommen | MS2 | Mittel |
| 15 | Umfragen / Abstimmungen | 🟡 Mittel | ✅ Übernommen | MS2 | Mittel |
| 16 | Verschiebbare Annotations-Toolbar | 🟡 Mittel | 🔜 Backlog | MS1 | Klein |
| 17 | Annotationstool-Favoriten | 🟡 Mittel | 🔜 Backlog | MS1 | Klein |
| 18 | Bewertungssystem für Stücke | 🟡 Mittel | 🔜 Backlog | MS2 | Klein |
| 19 | Excel-/CSV-Import für Archiv-Migration | 🟡 Mittel | 🔜 Backlog | MS1 | Mittel |
| 20 | Setlist teilen (auch an Nicht-Nutzer) | 🟡 Mittel | 🔜 Backlog | MS2 | Klein |
| 21 | Wiederkehrende Termine (Proben) | 🟡 Mittel | 🔜 Backlog | MS2 | Klein |
| 22 | Media Links (YouTube/Spotify) | 🟡 Mittel | ✅ Übernommen | MS2 | Klein |
| 23 | Lasso-/Auswahl-Werkzeug | 🟢 Niedrig | 🔜 Backlog | MS3 | Mittel |
| 24 | Playback-Integration (Begleitspuren) | 🟢 Niedrig | 🔜 Backlog | MS4 | Groß |
| 25 | Aufnahme-Funktion (Recorder) | 🟢 Niedrig | 🔜 Backlog | MS3 | Mittel |
| 26 | MusicXML-Import | 🟢 Niedrig | 🔜 Backlog | MS5 | Mittel |
| 27 | Konzertprogramm mit Timing | 🟢 Niedrig | ✅ Übernommen | MS2 | Klein |
| 28 | PDF-Export (Noten, Berichte) | 🟢 Niedrig | 🔜 Backlog | MS2 | Mittel |
| 29 | Platzhalter in Setlists | 🟢 Niedrig | ✅ Übernommen | MS2 | Klein |
| 30 | Aufgabenverwaltung / To-Do-Listen | 🟢 Niedrig | ✅ Übernommen | MS3 | Mittel |
| 31 | Auto-Scroll / Reflow | 🟢 Niedrig | ✅ Übernommen | MS3 | Mittel |
| 32 | Notenstore-Integration (IMSLP etc.) | 🟢 Niedrig | 🔜 Backlog | Backlog | Groß |
| 33 | Lokaler Relay-/Hotspot-Modus | 🟢 Niedrig | 🔜 Backlog | MS3 | Groß |
| 34 | AI-Annotations-Analyse (Cross-Part) | 🟢 Niedrig | ✅ Übernommen | MS4 | Groß |
| 35 | Face-Gesten für Seitenwechsel | ⚪ Nicht relevant | ✅ Übernommen | MS5 | Groß |
| 36 | MIDI-Controller-Support | ⚪ Nicht relevant | 🔜 Backlog | Backlog | Mittel |
| 37 | LiveScore AI (PDF → interaktive Partitur) | ⚪ Nicht relevant | 🔜 Backlog | Backlog | Groß |
| 38 | E-Reader-Unterstützung (PocketBook) | ⚪ Nicht relevant | 🔜 Backlog | Backlog | Groß |
| 39 | Finanzverwaltung / Buchhaltung | ⚪ Nicht relevant | 🔜 Backlog | Backlog | Groß |
| 40 | Inventarverwaltung (Instrumente) | ⚪ Nicht relevant | ✅ Übernommen | MS5 | Mittel |
| 41 | AI-Assistent (Sprach-Verwaltung) | ⚪ Nicht relevant | 🔜 Backlog | Backlog | Groß |
...
- **Status:** ✅ Übernommen — F-SM-07 (Should, MS1)
- **Empfohlene Priorität:** 🔴 Hoch für Wiederholungen (D.S., D.C., Coda)
...
- **Status:** ✅ Übernommen — F-SM-08 (Should, MS1)
- **Empfohlene Priorität:** 🟡 Mittel / Nachtmodus / Sepia
...
- **Bereits in unserer Spec?** ❌ Nein
- **Status:** ✅ Übernommen — F-SM-09 (Should, MS1)
- **Empfohlene Priorität:** 🟡 Mittel (Notenanzeige)
...
- **Status:** ✅ Übernommen — F-VL-05 (Should, MS2)
- **Empfohlene Priorität:** 🟡 Mittel / Reflow
...
- **Bereits in unserer Spec?** ❌ Nein
- **Status:** ✅ Übernommen — F-SM-10 (Could, MS3)
- **Empfohlene Priorität:** 🟢 Niedrig für Seitenwechsel
...
- **Bereits in unserer Spec?** ❌ Nein
- **Status:** ✅ Übernommen — F-SM-11 (Could, MS5)
- **Empfohlene Priorität:** ⚪ Nicht relevant & Metadaten
...
- **Bereits in unserer Spec?** ❌ Nein
- **Status:** ✅ Übernommen — F-SL-02 (Could, MS2)
- **Empfohlene Priorität:** 🟢 Niedrig
...
- **Bereits in unserer Spec?** ❌ Nein
- **Status:** ✅ Übernommen — F-SL-03 (Could, MS2)
- **Empfohlene Priorität:** 🟢 Niedrig (Noten, Setlists, Berichte)
...
- **Status:** ✅ Übernommen — F-VL-04 (Must, MS2)
- **Empfohlene Priorität:** 🔴 Hoch
- **Empfohlener Meilenstein:** MS2
- **Aufwand:** Mittel
...
- **Bereits in unserer Spec?** ❌ Nein
- **Status:** ✅ Übernommen — F-VL-08 (Should, MS2)
- **Empfohlene Priorität:** 🟡 Mittel / Abstimmungen
...
- **Bereits in unserer Spec?** ❌ Nein
- **Status:** ✅ Übernommen — F-VL-09 (Should, MS2)
- **Empfohlene Priorität:** 🟡 Mittel Benachrichtigungen
...
- **Status:** ✅ Übernommen — F-VL-07 (Should, MS2)
- **Empfohlene Priorität:** 🟡 Mittel
- **Empfohlener Meilenstein:** MS2
...
- **Status:** ✅ Übernommen — F-VL-06 (Should, MS2)
- **Empfohlene Priorität:** 🟡 Mittel
- **Empfohlener Meilenstein:** MS2
...
- **Status:** ✅ Übernommen — F-VL-03 erweitert (Should, MS2)
- **Empfohlene Priorität:** 🔴 Hoch
- **Empfohlener Meilenstein:** MS2
...
- **Bereits in unserer Spec?** ❌ Nein
- **Status:** ✅ Übernommen — F-VL-10 (Could, MS3)
- **Empfohlene Priorität:** 🟢 Niedrig: Übung & Lehre
...
- **In unserer Spec?** ❌ Nein
- **Status:** ✅ Übernommen — F-NV-08 (Should, MS2)
- **Empfohlene Priorität:** 🟡 Mittel AI (PDF → interaktive Partitur)
- **Gefunden bei:** Newzik
...
- **Bereits in unserer Spec?** ❌ Nein
- **Status:** ✅ Übernommen — F-VL-11 (Could, MS5)
- **Empfohlene Priorität:** ⚪ Nicht relevant
- **Empfohlener Meilenstein:** Backlog
...
*Dieses Dokument wurde von Fury (Business Analyst) erstellt. Thomas hat entschieden: 18 Features übernommen, restliche im Backlog.*
