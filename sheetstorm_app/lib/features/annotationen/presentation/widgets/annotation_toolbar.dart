...
class AnnotationToolbar extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final annotationState = ref.watch(annotationProvider(stuckId));
  ...
  Widget _buildToolbar(
    ...
    final children = <Widget>[
      ...
      _ToolbarButton(
        ...
        onTap: () =>
            ref.read(annotationProvider(stuckId).notifier).undo(),
      ),
      _ToolbarButton(
        icon: Icons.redo,
        label: 'Redo',
        ...
        onTap: () =>
            ref.read(annotationProvider(stuckId).notifier).redo(),
      ),
    ];
