...
enum AnnotationLevel {
  ...
  Color get color => switch (this) {
        AnnotationLevel.private => AppColors.annotationPrivate,
        AnnotationLevel.voice => AppColors.annotationVoice,
        AnnotationLevel.orchestra => AppColors.annotationOrchestra,
      };

  String get label => switch (this) {
        AnnotationLevel.private => 'Privat',
        AnnotationLevel.voice => 'Stimme',
        AnnotationLevel.orchestra => 'Orchester',
      };

  String get description => switch (this) {
        AnnotationLevel.private => 'nur für mich',
        AnnotationLevel.voice => 'alle mit gleicher Stimme',
        AnnotationLevel.orchestra => 'alle Kapellenmitglieder',
      };

  String get iconChar => switch (this) {
        AnnotationLevel.private => '👤',
        AnnotationLevel.voice => '🎵',
        AnnotationLevel.orchestra => '🎼',
      };
}
...
class LayerVisibility {
  ...
  bool isVisible(AnnotationLevel level) => switch (level) {
        AnnotationLevel.private => isPrivate,
        AnnotationLevel.voice => isVoice,
        AnnotationLevel.orchestra => isOrchestra,
      };

  LayerVisibility toggle(AnnotationLevel level) => switch (level) {
        AnnotationLevel.private =>
          LayerVisibility(isPrivate: !isPrivate, isVoice: isVoice, isOrchestra: isOrchestra),
        AnnotationLevel.voice =>
          LayerVisibility(isPrivate: isPrivate, isVoice: !isVoice, isOrchestra: isOrchestra),
        AnnotationLevel.orchestra =>
          LayerVisibility(isPrivate: isPrivate, isVoice: isVoice, isOrchestra: !isOrchestra),
  ...
  bool operator ==(Object other) =>
      ...
      other is LayerVisibility &&
          ...
          isOrchestra == other.isOrchestra;

  @override
  int get hashCode => Object.hash(isPrivate, isVoice, isOrchestra);
}
