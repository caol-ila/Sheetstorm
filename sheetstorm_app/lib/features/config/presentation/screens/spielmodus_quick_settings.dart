...
class SpielmodusQuickSettings extends ConsumerStatefulWidget {
  const SpielmodusQuickSettings({
    super.key,
  ...
  @override
  ConsumerState<SpielmodusQuickSettings> createState() =>
      _SpielmodusQuickSettingsState();
}

class _SpielmodusQuickSettingsState
    extends ConsumerState<SpielmodusQuickSettings>
                      ...
                      child: Column(
                        children: [
                          ...
                          _QuickToggle(
                            ...
                            label: 'Nachtmodus',
                            value: _getBoolValue(
                                configState, 'nutzer.theme', 'dark'),
                            isLocked: configState.isLocked('nutzer.theme'),
                            onChanged: (v) {
                              _onInteraction();
                              ref
                          ...
                          _QuickToggle(
                            ...
                            value: (configState.getValue<dynamic>(
                                    'nutzer.spielmodus.half_page_turn') ==
                                true),
  ...
  bool _getBoolValue(ConfigState state, String key, String trueValue) {
    final val = state.resolved[key]?.wert;
