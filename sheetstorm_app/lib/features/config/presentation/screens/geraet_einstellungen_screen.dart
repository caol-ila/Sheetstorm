...
class GeraetEinstellungenScreen extends ConsumerWidget {
  const GeraetEinstellungenScreen({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final configState = ref.watch(configNotifierProvider);
    final grouped = ConfigKeys.groupedByKategorie(ConfigEbene.geraet);
        ...
        Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: AppColors.configGerat.withOpacity(0.05),
              borderRadius: AppSpacing.roundedMd,
              border: Border.all(
                color: AppColors.configGerat.withOpacity(0.2),
              ),
            ),
            child: Row(
              children: [
    ...
    return Padding(
      ...
      child: Card(
        ...
        child: ConfigSettingTile(
          ...
          onOverride: resolved.herkunft != ConfigEbene.geraet &&
              ...
              : null,
          onReset: resolved.herkunft == ConfigEbene.geraet
              ? () {
                  ref
                      .read(configNotifierProvider.notifier)
                      .resetToParent(keyDef.schluessel, ConfigEbene.geraet);
                }
              : null,
        ),
      ),
