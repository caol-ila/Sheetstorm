...
class NightModeFilter extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (farbmodus == Farbmodus.standard && helligkeit >= 1.0) {
      return child;
    }
  ...
  ColorFilter _buildColorFilter() {
    return switch (farbmodus) {
      Farbmodus.standard => ColorFilter.matrix(_brightnessMatrix(helligkeit)),
      Farbmodus.nacht => ColorFilter.matrix(_nightModeMatrix(helligkeit)),
      Farbmodus.sepia => ColorFilter.matrix(_sepiaMatrix(helligkeit)),
    };
  }
