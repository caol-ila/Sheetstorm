...
class StimmeBottomSheet extends StatelessWidget {
  const StimmeBottomSheet({
    super.key,
    required this.stimmen,
    required this.currentStimmeId,
  ...
  Widget build(BuildContext context) {
    final userStimmen =
        stimmen.where((s) => s.isUserInstrument).toList();
    final otherStimmen =
        stimmen.where((s) => !s.isUserInstrument).toList()
  ...
  Widget _buildStimmeItem(BuildContext context, Stimme stimme) {
    final isSelected = stimme.id == currentStimmeId;
