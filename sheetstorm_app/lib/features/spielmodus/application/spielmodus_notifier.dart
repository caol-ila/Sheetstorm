...
class SpielmodusState {
  ...
  final List<Stimme> stimmen;
  final String? currentStimmeId;
  ...
  SpielmodusState copyWith({
    ...
    return SpielmodusState(
      ...
      stimmen: stimmen ?? this.stimmen,
      currentStimmeId: currentStimmeId ?? this.currentStimmeId,
...
class SpielmodusNotifier extends _$SpielmodusNotifier {
  ...
  Future<void> _loadSheetMusic() async {
    ...
    final stimmen = [
      const Stimme(id: 'kl2', name: '2. Klarinette', isUserInstrument: true),
      const Stimme(id: 'kl1', name: '1. Klarinette', isUserInstrument: true),
      const Stimme(id: 'tr1', name: 'Trompete 1'),
      const Stimme(id: 'tr2', name: 'Trompete 2'),
      const Stimme(id: 'fl', name: 'Flügelhorn'),
      const Stimme(id: 'hr', name: 'Horn in F'),
  ...
  void changeStimme(String stimmeId) {
    state = state.copyWith(
      currentStimmeId: stimmeId,
      currentPage: 0,
      halfPageStep: 0,
    );
    hideOverlay();
