...
void main() {
  ...
  // ─── Event.fromJson — Null-Sicherheit (#104) ──────────────────────────────

  group('Event.fromJson — Null-Sicherheit (#104)', () {
    test('Event.fromJson stürzt nicht ab wenn erstellt_von fehlt', () {
      // RED: Wirft aktuell einen Cast-Fehler — null as Map<String, dynamic>
    ...
    test('Event.fromJson parst korrekt wenn alle Felder vorhanden', () {
      final json = <String, dynamic>{
        'id': 'evt-full',
        'kapelle_id': 'band-1',
