...
void main() {
  group('PerformanceModeOverlay — visibility (AC-52)', () {
  ...
  group('PerformanceModeOverlay — page indicator', () {
  ...
  group('PerformanceModeOverlay — button callbacks', () {
  ...
  group('PerformanceModeOverlay — touch targets (AC-55)', () {
  ...
  group('PerformanceModeOverlay — night mode label', () {
  ...
  group('PerformanceModeOverlay — pointer ignore when hidden', () {
    testWidgets('overlay ignores pointer when invisible (AC-52)', (tester) async {
      await tester.pumpWidget(_buildOverlay(visible: false));
      await tester.pump();

      // Find the IgnorePointer that is a direct child of PerformanceModeOverlay
      final overlayFinder = find.byType(PerformanceModeOverlay);
